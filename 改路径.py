# description: The code generates a new csv each time when it operates
...
def get_source(URL, click_time):
    ...
    click_time: float
    """
    path_to_chromedriver = '/Users/kegong/Downloads/chromedriver'  # 改这里，改成自己本地chromedrive路径
...
# Extract corresponding data within each product
for i in soup.find_all('div', attrs={'itemtype': 'http://schema.org/Product'}):
